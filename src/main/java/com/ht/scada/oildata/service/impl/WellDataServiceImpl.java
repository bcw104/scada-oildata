...
//            float[] dl = dgtData.getArrayValueMap().get(VarSubTypeEnum.DIAN_LIU_ARRAY.toString().toLowerCase());
            GTDataComputerProcess gtData = new GTDataComputerProcess();
            ...
            Map<GTReturnKeyEnum, Object> calcMap = gtData.calcSGTData(weiyi, zaihe, power, null, wellData.getChongCi(), bengJing, oilDensity, hanShuiLiang);
